...
EXCLUDED_DIRS: Set[str] = {
    ".git", ".vscode",
    "__pycache__", ".pytest_cache", "logs", "node_modules", ".venv", "Anmol", ".anm", ".idea", "migrations", "build", "dist", ".next", ".cache", ".parcel-cache", "projects", "EXTRAA"
}

IGNORED_SUFFIXES: Set[str] = {
    ".db", ".wav", ".png", ".jpg", ".jpeg", ".gif"
}
